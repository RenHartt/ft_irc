...
IrcError::IrcError(const std::string &msg, e_IrcErrorType type) : _type(type)
{
	switch (type)
	{
		case SERVER : _msg = msg; break;
		case CLIENT_NONICKNAMEGIVEN: _msg = ERR_NONICKNAMEGIVEN(msg); break;
		case CLIENT_ALREADYREGISTERED: _msg = ERR_ALREADYREGISTERED(msg); break;
		case CLIENT_PASSWDMISMATCH: _msg = ERR_PASSWDMISMATCH(msg); break;
		case CLIENT_NOTREGISTERED: _msg = ERR_NOTREGISTERED(msg); break;
		case CLIENT_NORECIPIENT: _msg = ERR_NORECIPIENT(msg); break;
		case CLIENT_NOTEXTTOSEND: _msg = ERR_NOTEXTTOSEND(msg); break;
		default : _msg = msg;
	}
}
...
IrcError::IrcError(const std::string &msg, const std::string &msg2, e_IrcErrorType type) : _type(type)
{
	switch (type)
	{
		case CLIENT_NEEDMOREPARAMS: _msg = ERR_NEEDMOREPARAMS(msg, msg2); break;
		case CLIENT_NOTONCHANNEL: _msg = ERR_NOTONCHANNEL(msg, msg2); break;
		case CLIENT_CHANNELISFULL: _msg = ERR_CHANNELISFULL(msg, msg2); break;
		case CLIENT_BADCHANNELKEY: _msg = ERR_BADCHANNELKEY(msg, msg2); break;
		case CLIENT_INVITEONLYCHAN: _msg = ERR_INVITEONLYCHAN(msg, msg2); break;
		case CLIENT_NOSUCHCHANNEL: _msg = ERR_NOSUCHCHANNEL(msg, msg2); break;
		case CLIENT_CHANOPRIVSNEEDED: _msg = ERR_CHANOPRIVSNEEDED(msg, msg2); break;
		...
		e_IrcErrorType type) : _type(type)
{
	switch(type)
	{
		case CLIENT_USERNOTINCHANNEL: _msg = ERR_USERNOTINCHANNEL(msg, msg2, msg3); break;
		case CLIENT_USERONCHANNEL: _msg = ERR_USERONCHANNEL(msg, msg2, msg3); break;
		default: _msg = msg + " " + msg2 + " " + msg3;
	}
}
