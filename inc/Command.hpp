...
class Command
{
  ...
  private:
    ...
    void sendToChannel(Client *sender, const std::string &recipient, const std::string &message,
                       ChannelMap &channel_map);
    void sendToClient(Client *sender, const std::string &recipient, const std::string &message,
